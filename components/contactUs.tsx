    ...
    <section className={`${satoshi.className} bg-background py-20 px-6`}>
      <div className="gap-y-10">
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <p className="text-neutral-400 text-[22px]">Contact us to Become part of the Impact.</p>
          <div className="flex items-center gap-5 mt-5">
            <a href="#" aria-label="X" className="text-neutral-700 hover:text-primary transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
              </svg>
            </a>
            <a href="#" aria-label="Instagram" className="text-neutral-700 hover:text-primary transition-colors">
            ...
            <a href="#" aria-label="YouTube" className="text-neutral-700 hover:text-primary transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          {contacts.map(({ icon, label, detail }) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-neutral-400 text-[18px]">{detail}</p>
              </div>
