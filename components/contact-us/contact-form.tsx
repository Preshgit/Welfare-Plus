  ...
  return (
    <div className="flex flex-col lg:flex-row w-full bg-background items-center py-10 gap-8 lg:gap-x-5 px-5" id="contactForm">
      <div className="relative block w-150 px-24 flex-shrink-0">
        <Image src={MapImage} alt="map" height={600} width={600} className="dark:hidden" />
        <Image src={MapImageDark} alt="map" height={600} width={600} className="hidden dark:block" />
      </div>
      <div className="space-y-5 flex flex-1 flex-col">
        ...
        <form className="space-y-5  w-full justify-self-end">
          <div className="flex items-center justify-between border-2 rounded-2xl flex-row-reverse py-3 px-3 relative">
            ...
            <UserIcon className="dark:stroke-primary stroke-gray-500 absolute right-5" />
          </div>
