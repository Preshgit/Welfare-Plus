    ...
    <SectionContainer>
      <div className=" mx-auto space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-3 justify-center">
          ...
          <Image src="/wpLOGOpng 3.png" width={312.74} height={120.73} alt="welfare plus logo" className="object-cover md:block w-[200px] dark:hidden md:w-[321.74px]" />
          <Image src="/logodark.png" width={312.74} height={120.73} alt="welfare plus logo" className="object-cover hidden dark:block w-[200px]  md:w-[321.74px]" />
        </div>
