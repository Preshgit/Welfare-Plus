...
export default async function Page({
  ...
  return (
    <div>
      ...
      <FeatureSection content="Welfare Plus (in Finland) is exploring partnerships and coordinating agents in selected United States locations, including Texas, North Carolina, Virginia Beach, and New York, to strengthen international collaborations in assistive technology, therapy tools, social research, and social development programs." title={'United States'} image={AssistiveChair} alt="Man on wheel chair" />
